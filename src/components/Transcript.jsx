...
const Transcript = () => {
  ...
  return (
    <section id="transcript" className="py-20 bg-white">
      {/* Wrapper หลักสำหรับเส้นขีดด้านบน (border-t) */}
      <div className="mt-16 border-t pt-10 w-full">
        
        {/* ⭐ เพิ่ม div นี้: เพื่อจัดเนื้อหาให้อยู่ตรงกลาง (Centered Container) ⭐ */}
              ...
              {isOpen && (
                ...
                >
                  <div className="max-w-3xl mx-auto shadow-2xl rounded-lg overflow-hidden">
                    {/* ✅ แก้ไข 1: ลบ /public ออกจาก path รูปภาพ (ใส่แค่ /images/...) */}
                    <img 
